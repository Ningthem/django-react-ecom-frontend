(function ($) {
    ...
    $('.collection-slider-active').slick({
        ...
        rtl: true,
        prevArrow: false,
        nextArrow: '<span class="collection-icon-next"><i class="fas fa-arrow-right"></i></span>',
        responsive: [{
                breakpoint: 1500,
                settings: {
                    slidesToShow: 1,
    ...
    if ($('#Instafeed-3').length) {
        var feed = new Instafeed({
            ...
            resolution: 'standard_resolution',
            limit: 5,
            template: '<div class="single-instafeed-3"><li><a href="{{link}}" target="_new"><img src="{{image}}" /><i class="fas fa-search"></i></a></li></div>',
        });
        feed.run();
    }
    ...
    /*Add Toggle Button in Off Canvas Sub Menu*/
    $clickableSubMenu.siblings('a').append('<span class="menu-expand"><i class="fas fa-angle-down "></i></span>');
    /*Close Off Canvas Sub Menu*/
    $clickableSubMenu.slideUp();
    /*Category Sub Menu Toggle*/
    $clickableMainMenu.on('click', 'li a, li .menu-expand', function(e) {
        ...
        if ($this.parent('li').hasClass('sw-sub-wrap, has-sub-menu') || ($this.attr('href') === '#' || $this.hasClass('menu-expand'))) {
            e.preventDefault();
            if ($this.siblings('ul:visible').length) {
                $this.parent('li').removeClass('active').children('ul').slideUp().siblings('a').find('.menu-expand i').removeClass('fas fa-angle-up ').addClass('fas fa-angle-down');
                $this.parent('li').siblings('li').removeClass('active').find('ul:visible').slideUp().siblings('a').find('.menu-expand i').removeClass('fas fa-angle-up').addClass('fas fa-angle-down');
            } else {
                $this.parent('li').addClass('active').children('ul').slideDown().siblings('a').find('.menu-expand i').removeClass('fas fa-angle-down ').addClass('fas fa-angle-up');
                $this.parent('li').siblings('li').removeClass('active').find('ul:visible').slideUp().siblings('a').find('.menu-expand i').removeClass('fas fa-angle-up').addClass('fas fa-angle-down');
            }
        }
    });
    ...
    $('.flower-best-choice-slider').slick({
        ...
        rtl: true,
        prevArrow: false,
        nextArrow: '<span class="flower-best-choice-icon-next"><i class="fas fa-arrow-right"></i></span>',
        responsive: [{
                breakpoint: 1500,
                settings: {
                    slidesToShow: 1,
